...
public class DiningPhilosophers {
    public static void main(String[] args) throws Exception {
        ...
        DiningPhilosopherMonitor monitor = new DiningPhilosopherMonitor(numOfPhils); for (int i = 0; i < philosophers.length; i++)
...
//……
    ...
    public void putdown(int id) {
        ...
        try {
            ...
            test(leftOf(id)); // left neighbor test(rightOf(id));
            }
finally{
                lock.unlock();
            }
